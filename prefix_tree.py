...
class CompressedPrefixTree(SimplePrefixTree):
    ...
    def insert(self, value: Any, weight: float, prefix: List) -> None:
        ...
        if self.value == []:
            ...
            self._insert_normal(value, weight, prefix)
        else:
    ...
    def _insert_normal(self, value: Any, weight: float, prefix: List) -> None:
        ...
        if max_len > 0:
            ...
            if tree.value == prefix:
                ...
                tree.weight += weight
                tree._leaf_total += weight
                tree._insert_normal(value, weight, prefix)
                tree._sort_subtrees()
